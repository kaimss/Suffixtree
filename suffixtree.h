...
****************************************************************************/
int SuffixTree::getlength(Node *p)
{
	int len=0;
	if(p==root)
	  return len;
...
****************************************************************************/
string SuffixTree::getstr(Node *node)
{
	string str;
	if(node==root)
	    return "";
...
**此节点的地址传给cur 
****************************************************************************/
bool SuffixTree::search(Node *p,string str,Node *&cur)
{
	bool signal;
...
**存在返回true 
****************************************************************************/
bool SuffixTree::findstr(string str)
{
	Node *cur=NULL;
...
****************************************************************************/
string SuffixTree::findlongeststr()
{
	string s="";
	int len=0,cal=0;
	Node *a[max];
...
****************************************************************************/
void SuffixTree::finddeepestr(Node *a[],Node *p,int &cal)
{
	for(int i=0;i<p->count;i++)
	{
...
**计算后缀树中str出现的次数 
****************************************************************************/
int SuffixTree::count(string str)
{
	Node *cur=NULL;
...
**计算节点p的孩子中叶节点个数 
****************************************************************************/
int SuffixTree::countleaf(Node *p)
{
	int counts=0;
...
****************************************************************************/
bool SuffixTree::judgeleaf(Node *p)
{
	for(int i=0;i<p->count;i++)
	{
		Node *t=p->child[i]->below;
...
****************************************************************************/
void SuffixTree::show(Node *p,int repeat,int len)
{
